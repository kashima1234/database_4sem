...
#include "ui_adminorders.h"
#include <QSqlError>
#include <QSqlQuery>
#include <QMessageBox>
#include "adminmenu.h"

adminorders::adminorders(QWidget *parent) :
QMainWindow(parent),
  ui(new Ui::adminorders)
{
    ui->setupUi(this);
...
void adminorders::on_btnMenu_clicked()
{
    this->close();
