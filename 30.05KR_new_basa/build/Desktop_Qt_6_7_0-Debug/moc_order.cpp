...
constexpr auto qt_meta_stringdata_CLASSorderENDCLASS = QtMocHelpers::stringData(
    ...
    "on_btnMenu_clicked",
    "add",
    "on_btnEdit_1_clicked",
    "on_btnEdit_clicked",
    "on_recordFilterBtn_clicked"
);
...
Q_CONSTINIT const QMetaObject order::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSorderENDCLASS_t,
        ...
        // method 'add'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnEdit_1_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnEdit_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_recordFilterBtn_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void order::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->add(); break;
        case 4: _t->on_btnEdit_1_clicked(); break;
        case 5: _t->on_btnEdit_clicked(); break;
        case 6: _t->on_recordFilterBtn_clicked(); break;
        default: ;
        }
    }
    (void)_a;
